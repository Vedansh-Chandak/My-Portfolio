  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col font-montserrat relative px-4">
      <main className="relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between max-w-6xl mx-auto gap-8 mt-10 sm:mt-16 px-4">
          <div className="lg:w-1/2 w-full text-center lg:text-left mb-6 lg:mb-0">
            <h2 className="text-3xl sm:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-amber-400 to-yellow-500 font-[cinzel] mb-6">
      ...
      <div className="flex justify-center gap-x-8 sm:gap-x-16 mt-10 sm:mt-20 flex-wrap px-4">
  <div className="flex flex-col items-center mb-8 lg:mb-0">
    <p className="text-4xl sm:text-5xl lg:text-6xl font-mono text-yellow-400">10</p>
    <h4 className="text-lg sm:text-xl text-gray-400 mt-2">
      Completed <span className="font-bold text-white">Projects</span>
    </h4>
  </div>
  <div className="flex flex-col items-center mb-8 lg:mb-0">
    <p className="text-4xl sm:text-5xl lg:text-6xl font-mono text-yellow-400">1+</p>
    <h4 className="text-lg sm:text-xl text-gray-400 mt-2">
      ...
      <div className="mt-20 sm:mt-28 px-2">
        <CoadingSkills />
      </div>
    </div>
  );
